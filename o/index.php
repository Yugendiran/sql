...
if(isset($_POST['newsletter_submit'])){
    ...
    $insert_newsletter_query = "INSERT INTO newsletter(newsletter_email) VALUES('$enc_newsletter_email')";
    $insert_newsletter_result = mysqli_multi_query($connection, $insert_newsletter_query);
    ...
    if(!$insert_newsletter_result){
        ...
        alertBox("Newsletter subscribed");
                        ...
                        <form class="form" action="index.php" method="post">
                            <input type="text" placeholder="Your email here" name="newsletter_email" required>
                            <button name="newsletter_submit" type="submit">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
